...
class ToDoListsControllerTest < ActionController::TestCase
  ...
  test "should create to_do_list" do
    assert_difference('ToDoList.count') do
      post :create, to_do_list: { item_completed: @to_do_list.item_completed, list_item: @to_do_list.list_item, list_name: @to_do_list.list_name }
    end
  ...
  test "should update to_do_list" do
    patch :update, id: @to_do_list, to_do_list: { item_completed: @to_do_list.item_completed, list_item: @to_do_list.list_item, list_name: @to_do_list.list_name }
    assert_redirected_to to_do_list_path(assigns(:to_do_list))
  end
